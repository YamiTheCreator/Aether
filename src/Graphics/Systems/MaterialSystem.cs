    ...
    public void BindMaterial( ref Material material, ShaderProgram shader )
        {
            ...
            SetBasicMaterialUniforms( material, shader );
            SetEmissionUniforms( material, shader );
            SetPBRUniforms( material, shader );
            BindDiffuseTexture( material, shader, whiteTexture );
            BindNormalMap( material, shader );
            BindMetallicMap( material, shader );
            BindRoughnessMap( material, shader );
            BindAOMap( material, shader );
            BindEmissiveMap( material, shader );
        }

        private void SetBasicMaterialUniforms( Material material, ShaderProgram shader )
        {
        ...
        private void SetEmissionUniforms( Material material, ShaderProgram shader )
        {
        ...
        private void SetPBRUniforms( Material material, ShaderProgram shader )
        {
            shader.TrySetUniform( "uMetallic", material.Metallic );
            shader.TrySetUniform( "uRoughness", material.Roughness );
        }

        private void BindDiffuseTexture( Material material, ShaderProgram shader, Texture2D whiteTexture )
        {
        ...
        private void BindNormalMap( Material material, ShaderProgram shader )
        {
        ...
        private void BindMetallicMap( Material material, ShaderProgram shader )
        {
        ...
        private void BindRoughnessMap( Material material, ShaderProgram shader )
        {
        ...
        private void BindAOMap( Material material, ShaderProgram shader )
        {
        ...
        private void BindEmissiveMap( Material material, ShaderProgram shader )
        {
