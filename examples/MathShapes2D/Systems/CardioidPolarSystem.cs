...
/// <summary>
/// Cardioid polar system - generates cardioid in polar coordinates
/// </summary>
public class CardioidPolarSystem : SystemBase
{
    protected override void OnUpdate( float deltaTime )
    {
        ...
        foreach ( Entity entity in World.Filter<CardioidPolar>() )
        {
            ...
            GenerateCardioid( entity, ref cardioid, meshSystem, materialSystem );
        ...
        MaterialSystem materialSystem )
    {
        ...
        Vector4D<float> color = new( 1f, 1f, 1f, 1f ); // White
        ...
        Material material = materialSystem.CreateUnlit( new Vector3D<float>( 1f, 1f, 1f ) ); // White
